...
impl Pkcs12Builder {
    ...
    /// [PKCS #12 object](pkcs12::pfx::Pfx). A random salt is generated by
    ...
    /// [PKCS #12 object](pkcs12::pfx::Pfx). A random IV is generated by
    /// [`build_with_rng`](Pkcs12Builder::build_with_rng). Calling this clears any previously set
    ...
    /// Set attributes to associated with the key included in the generated [PKCS #12 object](pkcs12::pfx::Pfx).
    ...
    /// Set a MacDataBuilder instance for use in generating a MAC for the [PKCS #12 object](pkcs12::pfx::Pfx).
